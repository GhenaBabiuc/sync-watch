...
public class WebSocketController {
    ...
    public void handleLeave(@DestinationVariable String roomId, @Payload Map<String, Object> payload) {
        ...
        messagingTemplate.convertAndSend("/topic/room/" + roomId + "/userLeft", (Object) Map.of(
                "userId", userId
        ));
    }
    ...
    public void handleChangeQuality(@DestinationVariable String roomId, @Payload Map<String, Object> payload) {
        ...
        messagingTemplate.convertAndSend("/topic/room/" + roomId + "/qualityChanged", (Object) Map.of(
                "quality", quality,
                "userId", userId,
                "timestamp", System.currentTimeMillis()
        ));
