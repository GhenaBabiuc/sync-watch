            ...
            <div className="row">
                <div className="col-lg-8 mb-5">
                    ...
                    <Tabs defaultActiveKey="movies" id="contentTabs" className="mb-4">
                            ...
                            <div className="row g-4 mt-1">
                                ...
                                {movies.map(movie => (
                                    <div key={movie.id} className="col-md-6 col-lg-4">
                                        <Card className="content-card" onClick={() => openCreateModal(movie, 'MOVIE')}>
                        ...
                        <Tab eventKey="series" title={<><i className="fas fa-tv me-2"></i>Series ({series.length})</>}>
                            <div className="row g-4 mt-1">
                                {series.length === 0 &&
                        ...
                        <Tab eventKey="custom" title={<><i className="fas fa-link me-2"></i>Link / YouTube</>}>
                            <Card className="bg-dark text-white border border-secondary p-5 text-center"
                                ...
                                <p className="text-secondary mb-4" style={{maxWidth: '600px', margin: '0 auto'}}>
                                    Paste a link to a YouTube video or a direct link to a video file (.mp4, .m3u8) to
                                    watch with friends.
                                </p>
                ...
                <div className="col-lg-4">
                    ...
                    {rooms.length === 0 && (
                        <Alert variant="dark" className="border-0 bg-opacity-50 text-center py-4">
                            ...
                            <p className="mb-0 text-muted">No active rooms right now.<br/>Be the first to create one!
                            </p>
                        </Alert>
                    )}
